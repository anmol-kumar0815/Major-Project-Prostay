...
if(isset($_POST['signup']))
{
	...
	if($password === $repassword)
	{
		...
		{
			$sql = "INSERT INTO normaluser(NAME,EMAIL,PASSWORD,CONTACT) VALUES('{$name}','{$email}','{$password}','{$contact}')";
...
<html lang="en">
  ...
  <body>
		...
		<div class="container" style="margin-top: 85px;">
		  <p class="text-center title">Create Your Account With Prostay</p>
		  <hr class="bg-yellow" style="height: 2px; margin: 3px;">
		   <form class="shadow" action="<?php $_SERVER['PHP_SELF'];?>" method="post">
			 ...
			 <div align="center">
			   <input type="submit" class="btn bg-yellow" value="Signup" name="signup"/> <p style="padding-top: 5px;">Already have an account? <a href="login.php">Login</a></p>
			 </div>
		   </form>
		</div> <!-- container div -->
		<br>
