...
if(isset($_POST['upload'])) {
	...
	$food = $_POST['FOOD'];
	//Update
    $sql = "UPDATE addcard SET FOOD = '{$food}' WHERE ID = $id";
...
<html lang="en">
  ...
  <body>
		...
		<div class="container" style="margin-top: 85px;">
		    <h1 class="text-dark text-center title">Edit Food Section</h1>
			...
			<form class="shadow" action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
			    ...
			    <div class="form-group">
				    <label>Food *</label>
					<input type="text" class="form-control" value="<?php echo $row['FOOD'];?>" name="FOOD" placeholder="With Food/Without Food" required />
				</div>
