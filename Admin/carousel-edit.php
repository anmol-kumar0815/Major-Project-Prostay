...
if(isset($_POST['upload'])) {
	...
	if(empty($error)=== true)  {
	   ...
	   //Delete the image from the folder before delete 
	   ...
	   //Update
       $sql = "UPDATE $tablename SET IMAGE = '{$file_name}' WHERE ID  = $id";
...
<html lang="en">
  ...
  <body>
		...
		<div class="container" style="margin-top: 85px;">
		    <h1 class="text-dark text-center title">Edit Carousel Image</h1>
			...
			<form action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
			    <?php
					...
					$row = mysqli_fetch_assoc($result);
				?>
				<p class="sub-title" style="margin-bottom: 0;">Selected Image</p>
