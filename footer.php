			    ...
			    <div class="footer-nav">
			        <ul style="padding:0; margin: 0;">
						...
						<li class="footer-list"><a href="partner-policies.php" style="text-decoration: none; color: black; font-weight: 450;">Partner 
                            Policies</a></li>
						<br>
						<li class="social"><a href="https://www.youtube.com/results?search_query=prostay+comfort"><i class="fab fa-youtube" style="font-size:25px; color: black;" OnMouseOver="this.style.color='red'" OnMouseOut="this.style.color='black'"></i></a></li>
